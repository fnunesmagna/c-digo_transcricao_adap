...
custom_class_name = (f"projects/dipol-sist-invest-dev/locations/global/customClasses/CustomID-24")

# Criação do Phrase_set
phrase_set_response = adaptation_client.create_phrase_set(
    {
        "parent": parent,
        "phrase_set_id": "PhraseSet-Teste21",
        "phrase_set": {
            "boost": 20,
            "phrases": [
